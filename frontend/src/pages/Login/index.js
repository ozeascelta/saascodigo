		...
		<Container component="main" maxWidth="xs">
			...
			<Box mt={8}>
                        ...
                        <Box mt={8} textAlign="center">
                          ...
                          <a href="https://www.facebook.com/coresistemas.tecnologia" target="_blank" rel="noopener noreferrer">
                          <button style={{ backgroundColor: '#fe8d80', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>
